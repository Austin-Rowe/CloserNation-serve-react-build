...
const key = fs.readFileSync("/etc/letsencrypt/live/bestclosershow.com/privkey.pem");
const cert = fs.readFileSync("/etc/letsencrypt/live/bestclosershow.com/fullchain.pem");
